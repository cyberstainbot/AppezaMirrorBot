...
![GitHub](https://img.shields.io/github/license/priiiiyo/priiiiyo-mirror-bot)
...
- Clone this repo:
```
git clone https://github.com/priiiiyo/priiiiyo-mirror-bot mirrorbot/
cd mirrorbot
```
...
- Give stars and Fork this repo then upload **token.pickle** to your forks, or you can upload your **token.pickle** to your Index and put your **token.pickle** link to **TOKEN_PICKLE_URL**. How to generate **token.pickle**? [Read here](https://github.com/priiiiyo/priiiiyo-mirror-bot#getting-google-oauth-api-credential-file)
