...
class GoogleDriveHelper:
    ...
    def __upload_empty_file(self, path, file_name, mime_type, parent_id=None):
        ...
        file_metadata = {
            'name': file_name,
            'description': '👨‍🦰 ᴜᴘʟᴏᴀᴅᴇᴅ ᴜꜱɪɴɢ ᴘʀɪɪɪɪʏᴏ ᴍɪʀʀᴏʀʙᴏᴛ',
            'mimeType': mime_type,
        }
        ...
        try:
            ...
            if meta.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                if SHORTENER is not None and SHORTENER_API is not None:
                    surl = short_url(durl)
                    buttons.buildbutton("☁️ ɢᴏᴏɢʟᴇ ᴅʀɪᴠᴇ ☁️", surl)
                else:
                    buttons.buildbutton("☁️ ɢᴏᴏɢʟᴇ ᴅʀɪᴠᴇ ☁️", durl)
            ...
            for file in response.get('files', []):
                if file.get('mimeType') == "application/vnd.google-apps.folder":
                    ...
                    if SHORTENER is not None and SHORTENER_API is not None:
                        ...
                        msg += f"<b><a href={sfurl}>☁️ ɢᴏᴏɢʟᴇ ᴅʀɪᴠᴇ ☁️</a></b>"
                    else:
                        msg += f"<b><a href={furl}>☁️ ɢᴏᴏɢʟᴇ ᴅʀɪᴠᴇ ☁️</a></b>"
